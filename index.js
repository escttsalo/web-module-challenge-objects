...
let cheeseBurger = createMenuItem('Cheese-Burger', 12,'Lunch');
let calzone = createMenuItem('Calzone', 8, 'Dinner');
// console.log(pizza);
...
*/
reviews.push({name: "Salo", rating: 2, feedback:"Aboslutely appaulled."})
